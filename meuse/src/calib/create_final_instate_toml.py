...
def read_model(root,config_fn, log):
...
def change_config(model, 
    ...
    config["input"]["path_forcing"] = "../../3-input/forcing_Meuse_20050101_20180222_v2_wgs2_remapbil_semisstonn.nc"
...
if __name__ == "__main__":
    ...
    l = setup_logging('data/0-log', f'01-final_instate_tomls.log')
    try:
    ...
    try:
        mod = read_model(root, config_fn, l)
