...
cd ..
echo "Changed to $(pwd)"
pixi run snakemake -s "2_Snakefile.smk" --configfile "config/calib.yml" --profile "slurm/" --unlock
...
pixi run snakemake -s "2_Snakefile.smk" -c 1 --configfile "config/calib.yml" --profile "slurm/"
