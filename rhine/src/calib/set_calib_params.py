...
if __name__ == "__main__":
    ...
    try:
        if "snakemake" in globals():
            ...
            p = "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/staticmaps.nc"
            p_out = "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/staticmaps_redo.nc"
            ...
            sub_catch = "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/3-input/staticgeoms/subcatch_Hall.geojson"
            lakes_in = [
                "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/lake_hq_1244.csv",
                "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/lake_hq_1248.csv",
                "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/lake_hq_14005.csv",
                "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/lake_hq_14023.csv",
                "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/docs/14650/lake_hq_14029.csv"
            ]
            graph = json.load(open("P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/Hall_levels_graph.json"))
            graph_pred = json.load(open("P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/Hall_pred_graph.json"))
            graph_node = json.load(open("P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/Hall_nodes_graph.json"))
            level = 'level0'    
            best_params_previous = "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/calib_data/level0/best_params.csv"
            params_df = "P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/calib_data/level0/paramspace.csv"
            random_params = Path('P:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim', 'calib_data', level, 'random_params.csv')
            # params_df = pd.read_csv(params_df, index_col=0)
            # params_cols = params_df.columns
            # params_values = params_df.iloc[0].values
            params_str = "ksat~1.93/f~0.91/rd~0.55/st~1.48/nr~0.55/ml~0.03/nl~0.97/nf~0.97" 
            params = {str(item.split('~')[0]): float(item.split('~')[1]) for item in params_str.split('/')}
