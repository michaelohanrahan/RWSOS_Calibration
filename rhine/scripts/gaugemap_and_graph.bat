...
set cwd=p:/11209265-grade2023/wflow/RWSOS_Calibration/rhine
set new_root=p:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/gaugesadded
set config_root=p:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/1-external
set gauges=p:/11209265-grade2023/wflow/RWSOS_Calibration/rhine/data/2-interim/QGIS/to_wflow/hourly_gauges_all.geojson
set mode=w+
set basename=Hall
